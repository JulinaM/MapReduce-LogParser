...
public class LogMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
    ...
    public void map(LongWritable key, Text value, Context context)
        ...
        if (line != null) {
            ...
            System.out.println("Status code:  "+log.response);
            if("200".equals(log.response)) {
                context.write(new Text(log.request.split("\\s")[1]), new IntWritable(1));
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(logMapper.logParser.getLog().response);
    }
